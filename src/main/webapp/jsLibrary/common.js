if (function (a) {
    a.UCMenu = function (b, c) {
        var d = {
            sidebar: {fixed: !0, rememberToggle: !0, offCanvas: !0},
            sideNav: {
                hover: !1,
                showNotificationNumbers: "onhover",
                showArrows: !0,
                sideNavArrowIcon: "arrowDown",
                subOpenSpeed: 300,
                subCloseSpeed: 400,
        ...
        e.init = function () {
            ...
            var b = (a(".UCMenu"), a("#sideNav")), c = (b.find("li.current"), b.find("li")), d = b.find("a"),
                f = b.find("li>ul.sub"), q = f.find("li>a");
            ...
            !function (a) {
                ...
                var l = document.createElement("div"), m = {},
                ...
                l = null, a.cssEase = {
                    ...
                    var l = g(b, c, d, i), n = a.transit.enabled && m.transition,
